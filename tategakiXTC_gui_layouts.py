...
def build_left_settings_container_plan() -> dict[str, Any]:
    return {
        ...
        'scroll_minimum_content_width': 760,
...
def build_preset_section_plan(*, minimum_button_width: object = 104) -> dict[str, Any]:
    return {
        'row_spacing': 8,
        'apply_button_text': 'プリセット読込',
        'apply_tooltip': '選択中のプリセットを現在の組版へ読み込みます',
        'save_button_text': 'プリセット保存',
...
def build_right_preview_panel_plan() -> dict[str, Any]:
    return {
        ...
        'font_scroll_horizontal_scroll_bar_policy': 'as_needed',
        ...
        'device_scroll_horizontal_scroll_bar_policy': 'as_needed',

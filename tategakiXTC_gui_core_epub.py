...
_CORE_REEXPORT_ALIASES = (
    ('_require_ebooklib_epub', '_require_ebooklib_epub'),
    ('_require_bs4_beautifulsoup', '_require_bs4_beautifulsoup'),
    ('_epub_node_is_effectively_empty', '_epub_node_is_effectively_empty'),
    ('_prune_empty_epub_ancestors', '_prune_empty_epub_ancestors'),
    ('_strip_leading_start_text_from_epub_body', '_strip_leading_start_text_from_epub_body'),
    ('EpubInputDocument', 'EpubInputDocument'),
    ('EpubImageMap', 'EpubImageMap'),
    ('EpubImageBasenameMap', 'EpubImageBasenameMap'),
    ('BoldRuleSets', 'BoldRuleSets'),
    ('CSSRule', 'CSSRule'),
    ('EpubIndentProfile', 'EpubIndentProfile'),
    ('style_declares_bold', 'style_declares_bold'),
    ('extract_bold_rules', 'extract_bold_rules'),
    ('node_is_bold', 'node_is_bold'),
    ('is_paragraph_like', 'is_paragraph_like'),
    ('_epub_node_token_signature', '_epub_node_token_signature'),
    ('_epub_node_attr_tokens', '_epub_node_attr_tokens'),
    ('_epub_node_analysis_signature', '_epub_node_analysis_signature'),
    ('_epub_token_matches', '_epub_token_matches'),
    ('_epub_node_href', '_epub_node_href'),
    ('_epub_node_text', '_epub_node_text'),
    ('_epub_href_fragment', '_epub_href_fragment'),
    ('_epub_text_is_note_reference_marker', '_epub_text_is_note_reference_marker'),
    ('_epub_should_skip_auxiliary_node', '_epub_should_skip_auxiliary_node'),
    ('_epub_spine_document_is_auxiliary', '_epub_spine_document_is_auxiliary'),
    ('_epub_node_analysis', '_epub_node_analysis'),
    ('epub_should_skip_node', 'epub_should_skip_node'),
    ('epub_heading_level', 'epub_heading_level'),
    ('_parse_css_style_declarations_cached', '_parse_css_style_declarations_cached'),
    ('_parse_css_style_declarations', '_parse_css_style_declarations'),
    ('_split_css_selectors', '_split_css_selectors'),
    ('_sanitize_epub_css_selector', '_sanitize_epub_css_selector'),
    ('_normalize_epub_css_selector', '_normalize_epub_css_selector'),
    ('_parse_epub_css_simple_selector_matcher', '_parse_epub_css_simple_selector_matcher'),
    ('_parse_epub_css_selector_matcher', '_parse_epub_css_selector_matcher'),
    ('_epub_css_simple_selector_matches_node', '_epub_css_simple_selector_matches_node'),
    ('_epub_css_selector_matches_node', '_epub_css_selector_matches_node'),
    ('extract_epub_css_rules', 'extract_epub_css_rules'),
    ('_epub_css_node_cache_signature', '_epub_css_node_cache_signature'),
    ('_merged_epub_css_for_node', '_merged_epub_css_for_node'),
    ('_font_weight_value_is_bold', '_font_weight_value_is_bold'),
    ('_css_length_to_chars', '_css_length_to_chars'),
    ('epub_node_requests_pagebreak', 'epub_node_requests_pagebreak'),
    ('epub_pagebreak_node_is_marker', 'epub_pagebreak_node_is_marker'),
    ('epub_node_is_note_like', 'epub_node_is_note_like'),
    ('_epub_list_parent_meta', '_epub_list_parent_meta'),
    ('_epub_cached_list_prefix_map', '_epub_cached_list_prefix_map'),
    ('_epub_list_item_prefix', '_epub_list_item_prefix'),
    ('epub_node_indent_profile', 'epub_node_indent_profile'),
    ('_normalize_epub_href', '_normalize_epub_href'),
    ('_build_epub_image_maps', '_build_epub_image_maps'),
    ('_epub_xml_local_name', '_epub_xml_local_name'),
    ('_epub_structure_error', '_epub_structure_error'),
    ('_epub_find_container_rootfile_path', '_epub_find_container_rootfile_path'),
    ('_preflight_epub_package', '_preflight_epub_package'),
    ('_epub_package_has_encryption_descriptor', '_epub_package_has_encryption_descriptor'),
    ('_epub_spine_entry_id', '_epub_spine_entry_id'),
    ('_epub_spine_entry_is_linear', '_epub_spine_entry_is_linear'),
    ('_collect_epub_spine_documents', '_collect_epub_spine_documents'),
    ('load_epub_input_document', 'load_epub_input_document'),
    ('_classify_epub_embedded_image', '_classify_epub_embedded_image'),
    ('_make_inline_epub_image', '_make_inline_epub_image'),
    ('_inspect_epub_embedded_image', '_inspect_epub_embedded_image'),
    ('_prepare_inline_epub_image_bytes', '_prepare_inline_epub_image_bytes'),
    ('_resolve_epub_image_data', '_resolve_epub_image_data'),
    ('_decode_epub_data_image_uri', '_decode_epub_data_image_uri'),
    ('_extract_epub_css_url', '_extract_epub_css_url'),
    ('_first_epub_srcset_candidate', '_first_epub_srcset_candidate'),
    ('_epub_background_image_source', '_epub_background_image_source'),
    ('_epub_picture_node_source', '_epub_picture_node_source'),
    ('_epub_runs', '_epub_runs'),
    ('_normalize_epub_text_fragment', '_normalize_epub_text_fragment'),
    ('_epub_text_excluding_ruby_annotations', '_epub_text_excluding_ruby_annotations'),
    ('_epub_collect_ruby_text', '_epub_collect_ruby_text'),
    ('_extract_epub_ruby_parts', '_extract_epub_ruby_parts'),
    ('_epub_image_node_source', '_epub_image_node_source'),
    ('_render_epub_chapter_pages_from_html', '_render_epub_chapter_pages_from_html'),

...
- v1.3.8.x の細かな `docs/release_notes/RELEASE_NOTES_v1_3_8_*.md` / `docs/publish_checklists/PUBLISH_CHECKLIST_v1_3_8_*.md` は公開版には残していません。
- v1.3.6 から v1.4.0 までの差分は、この `docs/release_notes/RELEASE_NOTES_v1_4_0.md` と `CHANGELOG.md` の v1.4.0 項目へ統合しています。

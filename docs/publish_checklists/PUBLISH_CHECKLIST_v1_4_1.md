...
- [ ] `docs/release_notes/RELEASE_NOTES_v1_4_1.md` が、v1.4.0 から v1.4.1 までの差分まとめになっている。
- [ ] `docs/publish_checklists/PUBLISH_CHECKLIST_v1_4_1.md` が存在する。
...
- [ ] Release 本文には `docs/release_notes/RELEASE_NOTES_v1_4_1.md` の内容を使用する。

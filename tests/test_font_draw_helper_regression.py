...
class FontAndDrawHelperRegressionTests(unittest.TestCase):
    ...
    def test_glyph_position_modes_limit_punctuation_to_hanging_marks_and_allow_five_ichi_steps(self):
        ...
        lower_bracket_down_strong = core._lower_closing_bracket_extra_y_for_mode('」', 24, 'down_strong')
        lower_bracket_down_weak = core._lower_closing_bracket_extra_y_for_mode('」', 24, 'down_weak')
        ...
        self.assertEqual(lower_bracket_down_strong, 8)
        self.assertEqual(lower_bracket_down_weak, 4)
        ...
        self.assertGreater(lower_bracket_down_weak, lower_bracket_standard)
        self.assertGreater(lower_bracket_down_strong, lower_bracket_down_weak)
    ...
    def test_draw_char_tate_lower_closing_bracket_modes_move_only_target_up(self):
        ...
        down_strong_y = capture_extra_y('」', 'down_strong')
        down_weak_y = capture_extra_y('」', 'down_weak')
        standard_y = capture_extra_y('」', 'standard')
        up_weak_y = capture_extra_y('」', 'up_weak')
        up_strong_y = capture_extra_y('」', 'up_strong')
        self.assertEqual(down_strong_y, 4)
        self.assertEqual(down_weak_y, 0)

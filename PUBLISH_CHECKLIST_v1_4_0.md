...
- [ ] `RELEASE_NOTES_v1_4_0.md` が、v1.3.6 から v1.4.0 までの差分まとめになっている。
- [ ] `CHANGELOG.md` の先頭が `v1.4.0 - Public release` になっている。
- [ ] v1.3.8.x の細かな `RELEASE_NOTES_v1_3_8_*.md` / `PUBLISH_CHECKLIST_v1_3_8_*.md` が残っていない。
...
- [ ] Release 本文には `RELEASE_NOTES_v1_4_0.md` の内容を使用する。

# 縦書きXTC GUI Studio Public

**縦書きXTC GUI Studio Public** は、EPUB やテキストを、xteink X4 / X3 などで扱いやすい縦書き XTC / XTCH 形式へ変換するための Python GUI アプリです。
...
**TategakiXTC GUI Studio Public** is a Python desktop GUI tool for converting EPUB, plain text, Markdown, and image-based sources into vertical-reading XTC / XTCH files for xteink X4 / X3 and related devices.
...
現在の公開版は **v1.5.0** です。v1.4.2 以降の開発内容は、細かな作業版番号を前面に出さず、公開版 v1.5.0 として整理しています。

- 前回公開版: `v1.4.2`
- 今回公開版: `v1.5.0-public`
- GitHub Release tag: `v1.5.0`
- GitHub Release title: `v1.5.0 Public`
- GitHub公開版ファイル: `tategaki-xtc-gui-studio_v1.5.0-public.zip`
- 有償版ファイル名の目安: `tategaki-xtc-gui-studio_v1.5.0-full.zip`


## Public版とFull版の違い

このGitHub配布版は **Public版** です。通常のファイル読み込み、フォルダ一括変換、TXT / Markdown / EPUB / 画像入力、XTC / XTCH 出力、欧文横組み、URL横組み、行頭鍵括弧設定、ローカルTXTの青空文庫記法処理は利用できます。

有償配布中の **Full版**（`tategaki-xtc-gui-studio_v1.5.0-full.zip`）には、Public版に加えて以下の機能が含まれます。

- 青空文庫ダウンロード機能（作品検索、HTML / TXT取得、本文抽出）
- クリップボード変換機能（コピーしたテキストを一時TXTとして読み込み）
...
- 青空文庫の検索・ダウンロード機能とクリップボード変換機能を削除しました。
- 通常のファイル読み込み、フォルダ一括変換、TXT / Markdown / EPUB / 画像入力、XTC / XTCH 出力は維持しています。
- ローカルTXTの青空文庫記法パーサ、ルビ・外字・傍点・傍線・改ページ・字下げ注記の処理は維持しています。
- 欧文表示に「横組み」を追加し、縦書き本文中の英文を横方向のまとまりとして表示できるようにしました。
- URL横組みに対応しました。長い URL は `/` / `.` / `-` / `_` / `?` / `&` / `=` / `#` などの区切りで分割します。
- `https://` / `http://` / `www.` 単体のようにホスト部分が無い不完全なURL風文字列を、横組みURLとして扱わないよう修正しました。
- 行頭鍵括弧設定を追加しました。既定は従来どおり「空白なし」で、「1文字下げ」も選べます。
- 複数空行、連続会話行、ぶら下がり句読点直後の空行、短いルビ＋読点など、草枕テキストで確認した組版上の不自然さを修正しました。

詳細は `docs/release_notes/RELEASE_NOTES_v1_5_0.md` と `CHANGELOG.md` を参照してください。

## 過去の主な公開版

### v1.4.2

v1.4.2 は、v1.4.1 公開後の保守・安定化をまとめた公開版です。progress bar 表示方向、ギアメニュー英語化、禁則処理、起動時ログ処理、フォルダ一括変換停止表示、release/source-only zip hygiene の改善を統合しています。
...
v1.4.0 は、v1.3.6 以降の開発版で行った UI 整理、変換安定化、不具合修正をまとめた公開版です。旧 `device` view-mode 値は互換入力として受け入れますが、旧 device-view UI は復活させません。現行の右ペイン表示へ安全に丸めます。
...
- `tategaki_middle_dot_position_test_text_v1.txt` — 中黒位置補正確認用
...
- `docs/release_notes/RELEASE_NOTES_v1_5_0.md` — v1.4.2 から v1.5.0 までの差分まとめ
- `docs/publish_checklists/PUBLISH_CHECKLIST_v1_5_0.md` — v1.5.0 公開前チェックリスト
- `docs/release_notes/RELEASE_NOTES_v1_4_2.md` — v1.4.1 から v1.4.2 までの差分まとめ
- `docs/publish_checklists/PUBLISH_CHECKLIST_v1_4_2.md` — v1.4.2 公開前チェックリスト
- `docs/release_notes/RELEASE_NOTES_v1_4_1.md` — v1.4.0 から v1.4.1 までの差分まとめ
- `docs/publish_checklists/PUBLISH_CHECKLIST_v1_4_1.md` — v1.4.1 公開前チェックリスト
- `docs/release_notes/RELEASE_NOTES_v1_4_0.md` — v1.3.6 から v1.4.0 までの差分まとめ
- `docs/publish_checklists/PUBLISH_CHECKLIST_v1_4_0.md` — v1.4.0 公開前チェックリスト
- `docs/release_notes/RELEASE_NOTES_v1_3_6.md` — v1.3.5 から v1.3.6 までの差分まとめ
- `docs/publish_checklists/PUBLISH_CHECKLIST_v1_3_6.md` — v1.3.6 公開前チェックリスト
- `docs/release_notes/RELEASE_NOTES_v1_3_5.md` — v1.3.4 から v1.3.5 までの差分まとめ
- `docs/release_notes/RELEASE_NOTES_v1_3_4.md` — v1.3.3 から v1.3.4 までの差分まとめ
- `docs/release_notes/RELEASE_NOTES_v1_3_2.md` — v1.3.2 の更新内容
- `docs/publish_checklists/PUBLISH_CHECKLIST_v1_3_2.md` — v1.3.2 公開前チェックリスト
- `docs/release_notes/RELEASE_NOTES_v1_3_0.md` — v1.3.0 の更新内容
- `docs/release_notes/RELEASE_NOTES_v1_2_2.md` — v1.2.2 の更新内容
- `docs/release_notes/RELEASE_NOTES_v1_2_1.md` — v1.2.1 の更新内容
- `docs/release_notes/RELEASE_NOTES_v1_2_0.md` — v1.2.0 の更新内容
- `docs/release_notes/RELEASE_NOTES_v1_1_0.md` — v1.1.0 の更新内容
- `CHANGELOG.md` — 公開版単位の更新履歴

v1.5.0.1〜v1.5.0.26 や v1.4.3.x の細かな開発版 release notes / publish checklist は、公開版では残さず `docs/release_notes/RELEASE_NOTES_v1_5_0.md` と `CHANGELOG.md` に統合しています。

## GitHub Release での公開方針

v1.5.0 Public は、GitHub 上では以下の扱いで公開します。

- Release tag: `v1.5.0`
- Release title: `v1.5.0 Public`
- Previous tag: `v1.4.2`
- 添付ファイル: `tategaki-xtc-gui-studio_v1.5.0-public-source-only.zip`
- 添付ファイル: `tategaki-xtc-gui-studio_v1.5.0-public.zip`

Release 本文には `docs/release_notes/RELEASE_NOTES_v1_5_0.md` の内容を使用します。

v1.5.0 Public の公開対象は **Python GUI版の public-source-only zip / public zip** です。有償Full版・Windows exe版・体験版は別配布物として扱います。
...
フォントを public zip に含める場合は、対応するライセンス文書も含める必要があります。
...
public zip にフォントを同梱する場合は、`Font/NotoSansJP-Regular.ttf` などのフォント本体と `LICENSE_OFL.txt` を一緒に含めます。
...
ライセンス文書とフォント本体の整合が取れない場合、`build_release_zip.py` は public zip 作成を停止します。フォントを同梱しない検証を行う場合は、`build_release_zip.py` 実行前に `Font/` / `fonts/` を置かないか、一時的に退避してください。

## テスト

テストを実行する場合は、public zip を展開したフォルダーをカレントディレクトリにして実行することを推奨します。
...
public zip は以下で作成できます。

    .venv\Scripts\python.exe -B ^
      build_release_zip.py

作成済み public zip の検証は以下です。

    .venv\Scripts\python.exe -B ^
      build_release_zip.py ^
      --verify ^
      dist\tategaki-xtc-gui-studio_v1.5.0-public.zip

public zip の作成は、環境に応じて以下でも実行できます。
...
検証は任意の zip パスを指定できます。
    ...
    python build_release_zip.py --verify dist\tategaki-xtc-gui-studio_v1.5.0-public.zip

v1.5.0 の source-only zip は Python GUI版の source 構成に加えて `Font/` を同梱できます。Font フォルダが同梱されている public zip では、別コピー手順は不要です。source-only 配布に切り替える場合は、対応するフォント本体と `LICENSE_OFL.txt` の扱いを合わせてください。

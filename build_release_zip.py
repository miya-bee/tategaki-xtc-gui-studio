...
REQUIRED_PROJECT_APP_MODULE_FILES = (
    ...
    'tategakiXTC_gui_styles.py',
    'tategakiXTC_gui_help_texts.py',
    'tategakiXTC_gui_preset_helpers.py',
    'tategakiXTC_gui_completion_helpers.py',
...
REQUIRED_PROJECT_REGRESSION_TEST_FILES = (
    ...
    'tests/test_progress_bar_regression.py',
    ...
    'tests/test_startup_logging_regression.py',
...
REQUIRED_APP_CONTENT_MARKERS = {
    ...
    'tategakiXTC_gui_preset_helpers.py': (
        'def selected_preset_key_from_combo',
        'def preset_side_summary_text',
        '__all__',
    ),
    'tategakiXTC_gui_completion_helpers.py': (
